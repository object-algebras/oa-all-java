...
public class Builder {
    ...
    public static <T> T builderBuilder(Class<T> alg) {
        return (T) Proxy.newProxyInstance(alg.getClassLoader(), new Class[] { alg }, (x, m, args) -> new Builder(m,
                args));
    }
    ...
    private static Object buildArgument(Object arg, Object algebra) throws IllegalAccessException,
    ...
    private static Object buildObject(Builder arg, Object algebra) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
        return arg.build(algebra);
    }

    private static List<Object> buildList(List<?> argList, Object algebra) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
